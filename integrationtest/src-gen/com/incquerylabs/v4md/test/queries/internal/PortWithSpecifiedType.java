/**
 * Generated from platform:/resource/com.incquerylabs.v4md/src/test/com/incquerylabs/v4md/test/queries/SearchQueries.vql
 */
package com.incquerylabs.v4md.test.queries.internal;
...
public final class PortWithSpecifiedType extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: com.incquerylabs.v4md.test.queries.internal.PortWithSpecifiedType (visibility: PUBLIC, simpleName: PortWithSpecifiedType, identifier: com.incquerylabs.v4md.test.queries.internal.PortWithSpecifiedType, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: com.incquerylabs.v4md.test.queries.internal) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
   *     <b>not</b> at the class load time of the outer class, 
   *     but rather at the first call to {@link JvmGenericType: com.incquerylabs.v4md.test.queries.internal.PortWithSpecifiedType (visibility: PUBLIC, simpleName: PortWithSpecifiedType, identifier: com.incquerylabs.v4md.test.queries.internal.PortWithSpecifiedType, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: com.incquerylabs.v4md.test.queries.internal) (interface: false, strictFloatingPoint: false, anonymous: false)#instance()}.
   * 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public String getFullyQualifiedName() {
      return "com.incquerylabs.v4md.test.queries.PortWithSpecifiedType";
    }

...
pipeline {
	...
	parameters {
		string(name: 'RELEASE_VERSION', defaultValue: '2.1.0', 
		...
		stage('Build Plug-in') { 
			steps {
				dir ('com.incquerylabs.v4md'){
					sh "rm -r build/dependency-cache"

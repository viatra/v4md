...
public final class ConnectedPort extends BaseGeneratedEMFQuerySpecificationWithGenericMatcher {
  ...
  /**
   * Inner class allowing the singleton instance of {@link JvmGenericType: com.incquerylabs.v4md.test.queries.internal.ConnectedPort (visibility: PUBLIC, simpleName: ConnectedPort, identifier: com.incquerylabs.v4md.test.queries.internal.ConnectedPort, deprecated: <unset>) (abstract: false, static: false, final: true, packageName: com.incquerylabs.v4md.test.queries.internal) (interface: false, strictFloatingPoint: false, anonymous: false)} to be created 
  ...
  private static class GeneratedPQuery extends BaseGeneratedEMFPQuery {
    ...
    public String getFullyQualifiedName() {
      return "com.incquerylabs.v4md.test.queries.ConnectedPort";
    }
